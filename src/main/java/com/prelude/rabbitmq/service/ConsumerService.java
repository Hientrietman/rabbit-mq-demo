...
public class ConsumerService {
    ...
    @RabbitListener(queues = RabbitMQConfig.QUEUE_NAME, containerFactory = "autoFactory")
    ...
    @RabbitListener(queues = RabbitMQConfig.QUEUE_A, containerFactory = "autoFactory")
    ...
    @RabbitListener(queues = RabbitMQConfig.QUEUE_B, containerFactory = "autoFactory")
    public void consumeB(Map<String, Object> message) {
        System.out.println("Consumer B nhận được: " + message);
    }

    // Lắng nghe Queue Manual ACK
    @RabbitListener(queues = RabbitMQConfig.MANUAL_ACK_QUEUE, containerFactory = "manualFactory")
